...
export default function ResetPassword() {
    ...
    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 max-w-md">
            {passwordResetSuccess ? (
                <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <button
                        ...
                        className="my-12 flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                        Log In
                    </button>
                </div>
            ) : (
